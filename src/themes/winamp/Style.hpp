...
/// The inspector in the Winamp Modern skin: brushed-metal frames and capsule buttons, fields and
/// lists behind cobalt LCD glass with glowing text, LED indicators and EQ-style slider thumbs.
